...
// on the main page.
ReactDOM.render(React.createElement(app_component_1.AppComponent, null), document.getElementById("root"));
...
// Import the application modules.
var add_contact_form_component_1 = __webpack_require__(191);
var contact_list_component_1 = __webpack_require__(192);
var AppComponent = (function (_super) {
            ...
            _this.setState(function (state, props) {
                return ({
                    contacts: state.contacts.concat([
                        {
                            id: _this.getNextID(state.contacts),
                            name: name
                        }
                    ])
                });
    ...
    AppComponent.prototype.getNextID = function (contacts) {
        if (contacts.length) {
...
// Import the core React modules.
var React = __webpack_require__(16);
var AddContactFormComponent = (function (_super) {
...
var React = __webpack_require__(16);
var contact_list_item_component_1 = __webpack_require__(193);
...
// Import the core React modules.
var React = __webpack_require__(16);
var ContactListItemComponent = (function (_super) {
